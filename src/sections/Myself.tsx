  ...
  <div>
    <div>
      ...
      <Typography sx={{ marginBottom: '16px' }} variant="body1">
        ...
        of software products. With a history as developer within networks, loadbalancing and
        routing, I am also experienced in leading a team of developers and working according to
        Agile workflows.
      </Typography>
      <Typography variant="body1">
        In my spare time I usually play around with some coding projects, some of them you can
        find referenced on this webpage.
      </Typography>
    </div>
  </div>
);
...
export const Myself = ({ id }: { id: string }) => (
  <Section id={id} title="About Me"><Content /></Section>
);
