...
const skillsData: SkillItem[] = [
  {
    ...
    description: 'I have been working with Agile software development using Kanban or Scrum for +10 years. For the last 5+ years my role have been Agile Product Owner and Product Manager and before that I worked as Scrum Master (+4 years). I have most experience in software such as JIRA, Miro',
  },
  {
    img: programImg,
    title: 'Coding',
    subtitle: 'Programming languages',
    description: 'During my professional career I have delivered software in languages C, Golang and React on Typescript. I have also extensive experience writing scripts (Shell or Node.js) for utility, builds and test.',
  },
  {
    img: cicdImg,
    title: 'CICD',
  ...
  },
  {
    ...
    description: 'I have deployed production grade software on multiple Linux distributions including Ubuntu, SLES, Redhat and CentOS. I have directly been managing Ubuntu based servers for many years. I also possess knowledge about Linux file structure and basic knowledge of the Linux kernel.',
  },
];
